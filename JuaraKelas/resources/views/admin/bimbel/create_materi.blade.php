...
<form method="POST" action="{{ url('admin/materi/store') }}">
    {{ csrf_field() }}
    <h4 style="text-align: center">Form Tambah Data Materi</h4>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="nama_materi" name="nama_materi" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
    <label for="deskripsi" class="col-4 col-form-label">deskripsi</label> 
    <div class="col-8">
      <input id="deskripsi" name="deskripsi" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
    <label for="durasi_jam" class="col-4 col-form-label">Durasi Jam</label> 
    <div class="col-8">
      <input id="durasi_jam" name="durasi_jam" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
