...
<form method="POST" action="{{ url('admin/penjadwalan/store') }}">
    {{ csrf_field() }}
    <h4 style="text-align: center">Form Tambah Penjadwalan Kelas</h4>
    <div class="form-group row">
    <label for="kode_kelas" class="col-4 col-form-label">Kode</label> 
    <div class="col-8">
      <input id="kode_kelas" name="kode_kelas" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
    <label for="kelas" class="col-4 col-form-label">Kelas</label> 
    <div class="col-8">
      <input id="kelas" name="kelas" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
    <label for="hari" class="col-4 col-form-label">Hari</label> 
    <div class="col-8">
      <input id="hari" name="hari" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
    <label for="tgl_mulai" class="col-4 col-form-label">Tanggal Mulai</label> 
    <div class="col-8">
      <input id="tgl_mulai" name="tgl_mulai" type="date" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
    <label for="tgl_akhir" class="col-4 col-form-label">Tanggal Akhir</label> 
    <div class="col-8">
      <input id="tgl_akhir" name="tgl_akhir" type="date" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
    <label for="jam_mulai" class="col-4 col-form-label">Jam Mulai</label> 
    <div class="col-8">
      <input id="jam_mulai" name="jam_mulai" type="time" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
    <label for="jam_akhir" class="col-4 col-form-label">Jam Akhir</label> 
    <div class="col-8">
      <input id="jam_akhir" name="jam_akhir" type="time" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
