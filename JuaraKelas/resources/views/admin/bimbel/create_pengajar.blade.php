...
<form method="POST" action="{{ url('admin/pengajar/store') }}">
    {{ csrf_field() }}
    <h4 style="text-align: center">Form Tambah Data Pengajar</h4>
    <div class="form-group row">
    <label for="nip" class="col-4 col-form-label">NIP</label> 
    <div class="col-8">
      <input id="nip" name="nip" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
